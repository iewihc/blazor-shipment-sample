...
namespace Ekko.Library.Responselmpl
{
    public class OrderApproveResponse
    {
        ...
        public string pur_nbr { get; set; }
        public string cattname { get; set; }
        public string company { get; set; }
        public string company1 { get; set; }
        public string pack_p { get; set; }
        public string pboxy_nbr { get; set; }
        public string iny_nbr { get; set; }
        public string cus_lab { get; set; }
